...
import cwe from 'E:/React Projects/my-app/src/image/cwe.jpeg';
import cwek from 'E:/React Projects/my-app/src/image/cwek.png';
    ...
    <React.Fragment>
      ...
      <main>
        ...
        <List className={classes.root}>
            ...
            <ListItem alignItems="flex-start">
                <ListItemAvatar>
                <Avatar alt="Travis Howard" src={cwek} />
                </ListItemAvatar>
                <img src={PH} className={classes.logoPH} alt="logo" />
                <ListItemText
                primary="Summer Date app"
                secondary={
                    <React.Fragment>
                    <Typography
                        component="span"
                    ...
                    {" — when the time you feel lonely, you can just…"}
                    <Typography variant="body2" color="textSecondary" component="p">
                      Submited at: September 14, 2020
                    </Typography>
                    <Typography variant="body2" color="textSecondary" component="p">
            ...
            <ListItem alignItems="flex-start">
                <ListItemAvatar>
                <Avatar alt="Cindy Baker" src={cwe} />
                </ListItemAvatar>
                <img src={PH} className={classes.logoPH} alt="logo" />
                <ListItemText
                primary="Oui Oui"
                secondary={
                    ...
                    {' — This app will provide you a better life with...'}
                    <Typography variant="body2" color="textSecondary" component="p">
                      Submited at: September 14, 2020
                    </Typography>
                    <Typography variant="body2" color="textSecondary" component="p">
