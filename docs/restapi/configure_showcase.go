...
import (
	...
	"showcase-backend/docs/restapi/operations"
	"showcase-backend/docs/restapi/operations/user"
)

//go:generate swagger generate server --target ../../docs --name Showcase --spec ../swagger.yaml --principal interface{}
